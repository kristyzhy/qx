...
(function anonymous() {
    ...
    if (url.indexOf(p1) != -1) {
        ...
        obj.is_vip = true;
        obj.is_active = true;
        obj.avatar_url = 'https://telegraph-image.pages.dev/file/162f1dff7329e45d17553.jpg';
    } else if (url.indexOf(p2) != -1) {
        obj.jump_url = 'https://t.me/iosapp520';
        obj.button_text = '你死了就到期';
        $notify("代码破解成功", "叼毛你可以开心的玩耍了", "ios鸡神-YYDS");
        obj.title = '点击加入Tg';
        obj.sub_title_list = ['2099-09-09'];
        // obj.songNeedPay = 0;
    } else if (url.indexOf(p3) != -1) {
        obj.data.center.buttons[1].sub_text = '无法观看？点击此处添加TG反馈！';
        obj.data.center.buttons[1].link_url = 'https://t.me/iosapp520';
